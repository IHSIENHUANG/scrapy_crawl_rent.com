...
class BaiduSpider(CrawlSpider):
	...
	start_urls = [r'https://www.rent.com/california/riverside-apartments?page=2']
	...
	def parse(self,response):
		...
		flag = False
		for link in links:
			obj = re.match(r'https://www\.rent\.com/california/.*/.+[0-9]$',link.url,re.M|re.I)
			review = re.match(r'https://www\.rent\.com/california/riverside-apartments/.+review.+',link.url,re.M|re.I)	
